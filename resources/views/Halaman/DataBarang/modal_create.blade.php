        ...
        <div class="modal-body">
          <form action="{{ route('data_barang.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" maxlength="25" name="nama_barang" type="text" placeholder="Masukan Nama barang">
              </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" maxlength="20" name="harga_awal" type="number" >
              </div>
            <div class="mb-3">
